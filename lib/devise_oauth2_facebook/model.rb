...
module Devise #:nodoc:
  # module FacebookConnectable #:nodoc:
    module Models #:nodoc:
      ...
      #
      # +facebook_token_field+ - Defines the name of the Facebook session key database attribute/column.
      #
      ...
      module DeviseOauth2Facebook
        ...
        def store_facebook_credentials!(attributes = {})
          ...
          self.send(:"#{self.class.facebook_token_field}=", attributes[:token])
